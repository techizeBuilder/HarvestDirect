...
// Product routes
adminRouter.get('/products', authenticateAdmin, productController.getAllProducts);
adminRouter.get('/products/:id', authenticateAdmin, productController.getProductById);
adminRouter.post('/products', authenticateAdmin, productController.createProduct);
adminRouter.put('/products/:id', authenticateAdmin, productController.updateProduct);
adminRouter.patch('/products/:id/featured', authenticateAdmin, productController.toggleProductFeatured);
adminRouter.delete('/products/:id', authenticateAdmin, productController.deleteProduct);
adminRouter.get('/product-categories', authenticateAdmin, productController.getProductCategories);
adminRouter.get('/product-stock', authenticateAdmin, productController.getProductStock);
adminRouter.patch('/products/:id/stock', authenticateAdmin, productController.updateProductStock);
...
adminRouter.get('/order-statistics', authenticateAdmin, orderController.getOrderStatistics);
