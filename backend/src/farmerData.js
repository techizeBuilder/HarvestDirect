export const farmerData = [
  ...
  },
  {
    id: 6,
    name: "Krishna Iyer",
    specialty: "Traditional Spice Farmer",
    story: "Growing up watching my father tend to spice gardens, I learned that patience and traditional methods produce the most aromatic and flavorful spices. Our family recipes for processing have been passed down for generations.",
    location: "Idukki, Kerala",
    imageUrl: "https://images.unsplash.com/photo-1566492031773-4f4e44671d66?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
    featured: false
  }
];